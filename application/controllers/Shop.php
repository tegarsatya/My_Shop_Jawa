...
class Shop extends MY_Controller {
    ...
    public function sortby($sort, $page = null)
    {
		...
		$data['content'] = $this->shop->select(
            ['product.id', 'product.title AS product_title','category.slug AS category_slug','product.description', 'product.image', 'product.price', 'product.is_available', 'category.title AS category_title']
            )
